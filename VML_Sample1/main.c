...
void rootEntry()
{
	...
	ret = VMLRunMain(ASSEMBLIES_DLL_FILE, mono_aot_module_Sample1_info);
	fprintf(mono_log, "[VML_Sample1] Program::Main() returned %d\n", ret);
}
...
int main(int argc, char* argv[])
{
	...
	fprintf(mono_log, "[VML_Sample1] Setting command line args\n");
